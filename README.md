...
- 4 軸それぞれの解説文表示
- レスポンシブ対応(最小 320px、モバイル/タブレット/デスクトップ)-(AIで実装)
- BudouX による日本語の文節単位改行-(AIで実装)

### スコープ外(現状未実装 / 今後検討)

- SNS シェア機能(OGP カード)-現状未実装
- タイプ別おすすめキーボードの提示・アフィリエイトリンク-現状未実装
- 拡張機能(マウス機能・ボリューム調整エンコーダなど)のおすすめ度判定-現状未実装
- 質問順のランダム化-今後検討
